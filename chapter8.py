...
def getContours(img):
    ...
    for cnt in contours:
        ...
        if area > 500:  #This is good idea to do when there are small area contours they shall be neglected and focus on larger areas
            cv2.drawContours(imgContour, cnt, -1, (255,250,0), 3)
            ...
            elif objCorner == 4: objectType = "Quad"
